...
Usage:
    uv run adws/adw-plan-decompose.py "<prompt or path/to/prompt.md>" --spec-dir specs/example
    uv run adws/adw-plan-decompose.py "<revision request>" --spec specs/example/spec.md
