...
# ///
"""ADW Quality — run every applicable configured test, lint, typecheck and build.

Usage:
    uv run adws/adw-quality.py "<reason for the quality run>" [--config adws/adw_sssf_config/sssf.config.yaml] [--adw-id a1b2c3d4]
